...
{}
{\begin{itemize}%
	\item  Crafted individualized lessons for 40 students and constructed a Wordpress site with lessons and exercises for at home learning.
...
\ 
\section{Skills}
\cvitem{Languages}{JavaScript, Java, C++, Python, R, PHP, CSS}
\cvitem{Formats}{HTML, LaTeX, Markdown, JSON}
\cvitem{Frameworks}{React Native, Node.js, Express.js, Socket.io, Amazon Alexa, React, Angular}
\cvitem{Utilities}{Git, VIM, Bash, MongoDB, AWS S3, Xcode, Android Studio}
