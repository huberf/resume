...
{Winchester, TN}
{\begin{itemize}%
	\item A robust voice and text UI handling both intent parsing as well as execution of a "skills" built on the skills framework. Employs TensorFlow to determine context. (github.com/huberf/pal)
\end{itemize}}
\cventry
{Sep 2015 - Aug 2016}
...
\ 
\section{Skills}
\cvitem{Languages}{JavaScript, C++, Python, Java, R, PHP, CSS}
\cvitem{Markup}{HTML, LaTeX, Markdown}
\cvitem{Frameworks}{React Native, Node.js, Express.js, Socket.io, Amazon Alexa Skills Kit}
