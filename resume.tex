...
\ 
\section{Skills}
\cvitem{Languages}{JavaScript, Python, R, Java, C++, Clojure (intermediate), HTML, LaTeX, SQL, CSS}
\cvitem{Frameworks}{React Native, Node.js, Express.js, Socket.io, ROS, React, Angular, TensorFlow (intermediate)}
\cvitem{Utilities}{Git, Vim, Bash, MongoDB, Redis, PostgreSQL, AWS S3, Xcode, Android Studio, Docker}
