...
\cvitem{Frameworks}{React Native, Node.js, Express.js, Socket.io, Amazon Alexa, jQuery}
\cvitem{Utilities}{Git, VIM, Bash, MongoDB, Visual Studio Code, AWS, Xcode, Android Studio}
