...
\ 
\section{Skills}
\cvitem{Languages}{JavaScript, Python, Java, C++, Clojure (intermediate), HTML, LaTeX, SQL, CSS}
\cvitem{Frameworks}{React Native, Node.js, Express.js, Socket.io, Amazon Alexa, React, Angular, TensorFlow (intermediate)}
\cvitem{Utilities}{Git, Vim, Bash, MongoDB, PostgreSQL, AWS S3, Xcode, Android Studio}
